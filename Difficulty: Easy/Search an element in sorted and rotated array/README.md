<h2><a href="https://www.geeksforgeeks.org/problems/search-in-a-rotated-array0959/1?page=4&category=Searching,Binary%20Search%20Tree&sortBy=submissions">Search an element in sorted and rotated array</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a sorted and rotated array <strong>A </strong>of N distinct elements which are rotated at some point, and given an element <strong>K</strong>. The task is to find the index of the given element K in array A.</span></p>
